...
class Extensions_Plugin_Setup extends Plugin_Setup {
    ...
    protected function get_initial_setup() {
        return [
            ...
            "script_cookie_link" => "I want to accept the third-party cookies, the external content and the external scripts.",
        ];
    }
    ...
    protected function get_translated_setup() {
        return [
            ...
            "script_cookie_link" => esc_html__("I want to accept the third-party cookies, the external content and the external scripts.", DJS_EXTENSIONS_PLUGIN),
        ];
    }
}
?>
