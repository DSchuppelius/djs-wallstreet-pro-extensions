...
class Extensions_Plugin_Setup extends Plugin_Setup {
    ...
    protected function get_initial_setup() {
        return [
            ...
            "script_cookie_link" => "Yes, I want to accept the third-party cookies, the external content and the external scripts.",
            "script_cookie_nolink" => "No, I do not want to accept the third-party cookies, the external content and the external scripts.",
        ];
    }
    ...
    protected function get_translated_setup() {
        return [
            ...
            "script_cookie_link" => esc_html__("Yes, I want to accept the third-party cookies, the external content and the external scripts.", DJS_EXTENSIONS_PLUGIN),
            "script_cookie_nolink" => esc_html__("No, I do not want to accept the third-party cookies, the external content and the external scripts.", DJS_EXTENSIONS_PLUGIN)
        ];
    }
}
?>
