...
function show_scriptconsent(){
    ...
    echo '<div id="script_fullscreen" class="open"><h3>'. esc_html__("Third-party scripts", DJS_EXTENSIONS_PLUGIN).'</h3><button type="button" class="not close material-icons-outlined">close</button><p>' . mb_convert_encoding($current_setup->get("script_before"), 'HTML-ENTITIES') . '</p>';
